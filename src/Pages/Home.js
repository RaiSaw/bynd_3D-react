          ...
          <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div className="col-lg-6">
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-start">
                <Button as='a' href='/signup' id="signup-btn" boxShadow='dark-lg' justifySelf="space-between" fontWeight='bold' fontSize={18} size={['sm','md','lg']} color='#fff' rounded='15px' border='blue'>Sign up</Button>
                <Button as='a' href='/login' id="login-btn" boxShadow='dark-lg' justifySelf="space-between" fontWeight='bold' fontSize={18} size={['sm','md','lg']} color="#6c757d" rounded='15px' border='#6c757d' _hover={{bg:'#6c757d'}}>
                  Log in
                </Button>
              </div>
            </div>
        ...
        <div className="container justify-content-center">
          <div className="container p-4 py-lg-5 align-items-center justify-content-center rounded-3 border shadow-lg">
            <div className="container px-4 py-4 justify-content-center align-items-center" id="categories-cards">
              ...
              <div className="row row-cols-6 row-cols-lg-4 align-items-stretch justify-center space-x-8 g-1 py-5">
                {/* <div className="col"> */}
