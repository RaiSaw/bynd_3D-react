    ...
    <div className="container marketing">
      ...
      <div className="row">
        <div className="col-lg-4">
          <img className="bd-placeholder-img rounded-circle" width="140" height="140" src="Assets/cdd20-9-dkDEXWGzI-unsplash.jpg"/>
        ...
        <div className="col-lg-4">
          <img className="bd-placeholder-img rounded-circle" width="140" height="140" src="Assets/amr-taha-qJit4JqiYLU-unsplash.jpg"/>
        ...
        <div className="col-lg-4 justify-center">
          <img className="bd-placeholder-img rounded-circle" width="140" height="140" src="Assets/simon-lee-vYsX30q0ARE-unsplash.jpg"/>
